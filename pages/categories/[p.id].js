          ...
          <div className="flex flex-wrap -m-4">
            {data.map((producto) => (
              <Link
                ...
                className="p-4 sm:w-1/2 lg:w-1/3 border mb-5 mx-3 md:mx-0 border-gray-200 bg-white shadow-lg lg:my-4 min-h-[400px] flex flex-col justify-between rounded-lg"
                // className="my-1 w-full md:w-1/2 md:flex "
              >
                ...
                <button className="self-end font-philo text-center bg-[#052617] w-full text-[#D9BF73] py-3 rounded-md hover:bg-[#0c5836] duration-1000 uppercase mb-4">
                  Add to Cart
                </button>
              </Link>
            ))}
